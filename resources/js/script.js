...
define('fares',['jquery', 'tinysort'], function ($, tinysort) {
    ...
    function HTMLFares() {
        ...
        for (var i = 0; i < fares.length; i++)
        {
            ...
            if ($(".company").text().length == 0) {
                ...
                if (vognNummer != null) {
                    if (vognNummer != "") {
                        $(".company").text(fares[i].VognNummer);
                    }
                }
            }
        ...
        if (fares.length == 0) {
            ...
            //htmlFare += "<div class='no-fares'><h3>Ingen køreture er planlagt for dig idag</h3></div>";
        }
        else {
    ...
    function GetFaresByUser(user, date) {
        ...
        $.ajax({
            ...
            data: "{username:'" + username + "',password:'" + password + "',company:'" + company + "',date:'" + date + "'}",
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            success: function (result) {
                ...
                if (firstRun) {
                    ...
                    console.log("oldFares:");
                    console.log(oldFares);


                    console.log(faresString);
